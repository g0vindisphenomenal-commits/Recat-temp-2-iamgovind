                  ...
                  >
                    ...
                    {entry.href && (
                      <a
                        ...
                        className="ml-auto text-[13px] font-medium text-foreground/70 transition-colors hover:text-foreground border border-foreground/10 hover:bg-foreground/5 rounded-xl px-3 py-1.5 inline-flex items-center gap-1 cursor-pointer focus-ring shrink-0"
                      >
                        Visit
