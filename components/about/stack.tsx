...
const CHIPS: Chip[] = [
  ...
  { label: "Elementor", icon: "elementor", bg: "#92003B", fg: "#ffffff" },
  ...
  { label: "FastAPI", icon: "fastapi", bg: "#009688", fg: "#ffffff" },
  { label: "Flask", icon: "flask", bg: "#000000", fg: "#3BABC3" },
  { label: "Pytest", icon: "pytest", bg: "#0A9EDC", fg: "#ffffff" },
  { label: "AWS", icon: "aws", bg: "#252F3E", fg: "#FF9900" },
  { label: "Azure", icon: "azure", bg: "#0089D6", fg: "#ffffff" },
  { label: "GCP", icon: "gcp", bg: "#4285F4", fg: "#ffffff" },
  { label: "PostgreSQL", icon: "postgresql", bg: "#336791", fg: "#ffffff" },
  ...
  { label: "GitHub Actions", icon: "githubactions", bg: "#2088FF", fg: "#ffffff" },
